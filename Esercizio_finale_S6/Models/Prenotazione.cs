...
namespace Esercizio_finale_S6.Models
{
    public class Prenotazione
    {
        ...
        [Required(ErrorMessage = "Seleziona una camera")]
        ...
        [Required(ErrorMessage = "Inserisci la caparra confirmatoria")]
        public decimal CaparraConfirmatoria { get; set; }

        [Required(ErrorMessage = "Inserisci la tariffa applicata")]
